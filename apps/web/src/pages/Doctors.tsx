...
const Doctors = () => {
  return (
    <section className="w-full flex flex-col gap-10 h-full p-2 items-center text-neutral-600">
      <h1 className="text-center text-sarthi-text-secondary mt-15">
        Meet Our <span className="text-sarthi-green">Expert Doctor</span>
      </h1>
      <section className="flex flex-wrap justify-center gap-10 p-0 md:px-4">
        <figure className="w-[280px] md:w-[500px]">
          <img
            style={{
              borderTopLeftRadius: "50%",
              borderBottomRightRadius: "50%",
            }}
            className="aspect-square w-full object-cover max-h-[500px] border-x-sarthi-green border-x-8"
            src={doctorImg}
            alt=""
          />
        </figure>
        <section className="flex gap-5 flex-col px-2 max-w-3xl">
          <section className="flex items-center text-center flex-col gap-1">
